...
export const metadata: Metadata = {
  ...
  description: 'Daniel is a frontend developer with 1 year of experience.',
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        <div className="bg-[#fbe2e2] absolute -z-10 top-[-6rem] right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem]"></div>
